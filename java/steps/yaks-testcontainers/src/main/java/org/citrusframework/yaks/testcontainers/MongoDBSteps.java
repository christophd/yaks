...
public class MongoDBSteps {
    ...
    public void before(Scenario scenario) {
        if (citrus.getCitrusContext().getReferenceResolver().isResolvable(MongoDBSettings.getContainerName(), MongoDBContainer.class)) {
            MongoDBContainer mongoDBContainer = citrus.getCitrusContext().getReferenceResolver().resolve(MongoDBSettings.getContainerName(), MongoDBContainer.class);
            MongoDBSettings.exposeConnectionSettings(mongoDBContainer, serviceName, context);
        }
    }
